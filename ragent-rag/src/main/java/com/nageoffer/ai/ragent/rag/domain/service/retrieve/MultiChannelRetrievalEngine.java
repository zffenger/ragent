...
import com.nageoffer.ai.ragent.rag.domain.service.retrieve.channel.SearchChannel;
import com.nageoffer.ai.ragent.rag.domain.service.retrieve.channel.SearchChannelResult;
import com.nageoffer.ai.ragent.rag.domain.service.retrieve.channel.SearchContext;
import com.nageoffer.ai.ragent.rag.domain.service.retrieve.postprocessor.SearchResultPostProcessor;
...
public class MultiChannelRetrievalEngine {
     ...
     */
    @RagTraceNode(name = "multi-channel-retrieval", type = "RETRIEVE_CHANNEL")
    public List<RetrievedChunk> retrieveKnowledgeChannels(List<SubQuestionIntent> subIntents, int topK, List<String> knowledgeBaseIds) {
        // 构建检索上下文
        SearchContext context = buildSearchContext(subIntents, topK, knowledgeBaseIds);
     ...
     * 构建检索上下文
     */
    private SearchContext buildSearchContext(List<SubQuestionIntent> subIntents, int topK, List<String> knowledgeBaseIds) {
