...
package com.nageoffer.ai.ragent.infra.ai.infra.http;

import com.nageoffer.ai.ragent.infra.ai.domain.vo.ModelCandidateConfig;
...
public class ModelUrlResolver {
    ...
    public static String resolveUrl(
            ...
            ModelCandidateConfig candidate,
        ...
        Map<String, String> endpoints = provider.endpoints();
        ...
        return joinUrl(provider.url(), path);
    }
