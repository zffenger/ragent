...
import com.nageoffer.ai.ragent.chatbot.infra.adapter.wework.WeWorkMessageDTO;
...
public class WeWorkApiClient {
    ...
    public void sendTextMessage(String toUser, String content) {
        ...
        WeWorkMessageDTO message = WeWorkMessageDTO.text(toUser, agentId, content);
        ...
        try (Response response = httpClient.newCall(request).execute()) {
            ...
            WeWorkResponseDTO resp = JSON.parseObject(responseBody, WeWorkResponseDTO.class);
