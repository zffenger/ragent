...
public class WeWorkMessage {
     ...
     * 创建文本消息
     */
    public static WeWorkMessage text(String toUser, Integer agentId, String content) {
     ...
     * 创建 Markdown 消息
     */
    public static WeWorkMessage markdown(String toUser, Integer agentId, String content) {
        WeWorkMessage message = new WeWorkMessage();
        message.setTouser(toUser);
        message.setAgentid(agentId);
